...
int uclock() 
{
    ...
    while(1)
    {
     //  ThisThread::sleep_for(1s);
        ...
        messdateandtime.year    = year;
        messdateandtime.day     = day;
        messdateandtime.mth     = mth;
        messdateandtime.dow     = dow;
        messdateandtime.hr      = hr;
        messdateandtime.minu    = minu;
        messdateandtime.sec     = sec;
        messdateandtime.smonth  = smth[mth];
        messdateandtime.weekday = swd[dow]; 
    }
}
